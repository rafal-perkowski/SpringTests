...
@Configuration
@ComponentScan
public class SbpJarSpringdata6Application {
	...
	public static void main(String[] args) {
		...
		*/
		...
		SbpJarSpringdata6Application tmpApp = new SbpJarSpringdata6Application();
		
		ConfigurableApplicationContext ctx = SpringApplication.run(SbpJarSpringdata6Application.class, args);
