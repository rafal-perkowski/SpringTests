...
@Configuration
@ComponentScan
public class SbpJarSpringdata5Application {
	...
	public static void main(String[] args) {
		...
		*/
		...
		SbpJarSpringdata5Application tmpApp = new SbpJarSpringdata5Application();
		
		ConfigurableApplicationContext ctx = SpringApplication.run(SbpJarSpringdata5Application.class, args);
