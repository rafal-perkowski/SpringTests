...
@Configuration
@ComponentScan
public class SbpJarSpringdata2Application {
	...
	public static void main(String[] args) {
		...
		*/
		...
		ConfigurableApplicationContext ctx = SpringApplication.run(SbpJarSpringdata2Application.class, args);
		...
		Page<Car> carsPage = carRepo.findAll(new PageRequest(0, 20));
